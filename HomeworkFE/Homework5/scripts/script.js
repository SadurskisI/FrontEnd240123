...
// 
// const firstNum = prompt("Insert first number")
// const secondNum = prompt("Insert second number")
// 
// if (firstNum > secondNum) {
//     console.log(secondNum +" is smaller number");
// } else {
//     console.log(firstNum +" is smaller number");
// }
...
// 
// const checkNum = prompt("Insert a number for check")
// 
// if (checkNum > 100) {
